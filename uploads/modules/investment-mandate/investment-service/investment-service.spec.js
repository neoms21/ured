...
import { TOGGLE_CUSTODIAN_ANSWER } from "./invesetment-service-action-types";
...
describe("investment services tests", () => {
  ...
  it("should render the text area if custody is selected", () => {
    initialState.investmentServices.custody = true;
