...
import RoundButtonsList from "./../../common/round-buttons-list/round-buttons-list";
...
class InvestmentService extends Component {
  ...
  handleCustodianQuestionClick = answer => {
    this.props.toggleCustodyAnswer(answer.id);
  };
      ...
      <div>
        ...
        {loadComplete && (
          <div>
            ...
            <LinearDropdown
              showOther={false}
              label="Do you wish to appoint an alternative External Custodian?"
              helpText={fields["requiresAlternativeExternalCustodian"].helpText}
              items={[
                { id: true, value: "Yes" },
                {
                  id: false,
              ...
              selectedItem={custody}
            />
            {custody && (
              <FormTextArea
                fields={fields}
                fieldName="requiresAlternativeExternalCustodian"
                mandatory={fields["requiresAlternativeExternalCustodian"].mandatory}
                errorText={
