...
import { TOGGLE_ADDITIONAL_REPORTS } from "./reporting-action-types";

describe("Reporting specs", () => {
  let store;
  let container;

  let initialState = { reporting: { lists: { portfolioTypes: [{ id: 2, value: "val 1" }, { id: 2, value: "val 2" }, { id: 3, value: "val 3" }], currencies: [], portfolioTimeHorizons: [] }, dataLoaded: true, fields: { portfolioReports: { label: "aa" }, portfolioPaperReporting: {}, requirePortfolioReports: {} }, objectives: [{ id: 1, value: "11" }, { id: 2, value: "11" }] }, tracker: {}, form: { reporting: { values: {} } } };
