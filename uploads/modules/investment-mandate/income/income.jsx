...
import BankAccountsContainer from "../../banks/bank-accounts-container";
...
class PortfolioIncome extends Component {
  ...
  handleBankAccountChange = (item, fieldName) => {
    if (item.id === "add") this.props.openModal();
  };
          ...
          formValues && (
            <div>
              ...
              {formValues["portfolioIncomeSeparate"] !== undefined && (
                <YesNo
                  fields={fields}
                  fieldName="portfolioWithdrawals"
                  onSelect={item => {
                    if (item.id)
                      this.props.toggleRegularPayments(
                        true,
                        this.props.formValues
                      );
                    else this.props.removeAllPayments(this.props.formValues);
                  }}
                />
              )}
              ...
              {formValues["portfolioWithdrawals"] !== undefined && (
                <YesNo
                  fields={fields}
