...
import ImageButton from "../common/buttons/image-button";
...
const ibanFormatValidator = alphaNumericValidatorComposer(1, 34);
const bicFormatValidator = alphaNumericValidatorComposer(8, 11);
...
export default function({
  ...
  return (
    <div>
      {index !== 1 && <h3>Bank account {index}</h3>}
...
function getValidators(name, index, fields) {
  ...
  switch (name) {
    ...
    case "bankAccountIBAN": {
      return [ibanValidator, ibanFormatValidator, conditionalFieldsValidator];
    }
    case "bankBicCode": {
      return [bicValidator, bicFormatValidator, conditionalFieldsValidator];
    }
    case "bankAbaFedwire": {
