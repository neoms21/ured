...
class Accountant extends Component {
  ...
  render() {
    const { fields, loadComplete, haveAccountant, countries } = this.props;

    return <div>
        <h2 className={styles.heading}>Accountant</h2>

        {loadComplete && <div>
            <YesNo fields={fields} fieldName="haveAccountant" />

            {haveAccountant && <div className={styles.container}>
