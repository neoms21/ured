...
class WealthObjectives extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      otherSelected:
        props.otherWealthPlanningObjective &&
        props.otherWealthPlanningObjective.value !== undefined,

      requiredWealthService:
        props.fields.requiredWealthService &&
        props.fields.requiredWealthService.value,
      advised:
        props.fields.lastWealthAdviceDate &&
        props.fields.lastWealthAdviceDate.value !== undefined
    };
  }
      ...
      <div className={styles.container}>
        ...
        {this.props.loadComplete && (
          <div>
            ...
            <BigButtons
              items={[{ id: true, value: "On-going wealth planning advice" }, { id: false, value: "One-off advice" }]}
              fields={fields}
