...
const initialState = {
  ...
  incomeManagementOptions: [
    {
      id: 1,
      value:
        "Income should accumulate on an Income Account until further notice"
    },
    {
      id: 2,
      value: "Pay the accumulated income to a bank account on a quarterly basis"
    }
  ],
  paymentSources: [
    {
