        ...
        return (
            <div>
                ...
                <svg width="501px" height="354px" viewBox="0 0 501 354" version="1.1">
                    <defs>
                        <rect id="path-1" x="69" y="21" width="432" height="280"></rect>
                    ...
                    <g id="Hover" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                        <g id="Rectangle-10-Copy">
                            <use fill="#F2F4F7" fillRule="evenodd" xlinkHref="#path-1"></use>
                            <rect
                                stroke="#A6A6A6"
                                strokeWidth="1"
                                x="69.5"
                        ...
                        <path d="M69.5,300.5 L500.5,21.5" id="Line-Copy-3" stroke="#A6A6A6"></path>
                        <text
                            ...
                            line-spacing="19"
                            fill="#4A4A4A">
                            <tspan x="0.688" y="52">Very high</tspan>
                            <tspan x="29.68" y="108">High</tspan>
                            <tspan x="-0.428" y="164">Moderate</tspan>
                            <tspan x="12.22" y="220">Limited</tspan>
                            <tspan x="33.52" y="276">Low</tspan>
                        </text>
                        <path
                            d="M70,49 L459,49 L459,301"
                            id="Path-3-Copy-5"
                            stroke="#A6A6A6"
                            strokeDasharray="1,3"></path>
                        <path
                            d="M70,105 L372,105 L372,301"
                            id="Path-3-Copy-6"
                            stroke="#A6A6A6"
                            strokeDasharray="1,3"></path>
                        <path
                            d="M70,161 L286,161 L286,301"
                            id="Path-3-Copy-7"
                            stroke="#A6A6A6"
                            strokeDasharray="1,3"></path>
                        <path
                            d="M70,217 L200,217 L200,301"
                            id="Path-3-Copy-8"
                            stroke="#A6A6A6"
                            strokeDasharray="1,3"></path>
                        <path
                            d="M70,273 L113,273 L113,301"
                            id="Path-3-Copy-9"
                            stroke="#A6A6A6"
                            strokeDasharray="1,3"></path>
                        <g id="circle/hover" transform="translate(94.000000, 255.000000)">
                            <g
                                ...
                                <use
                                    id="1"
                                    fill={this.state.icons['1'].selected
                                        ? '#2D55B2'
                                        : '#FFF'}
                                    fillRule="evenodd"
                                    xlinkHref="#path-4"></use>
                                <circle stroke="#002A5E" strokeWidth="1" cx="18" cy="18" r="17.5"></circle>
                            </g>
                        </g>
                        ...
                        <g id="circle/hover" transform="translate(182.000000, 199.000000)">
                            <g
                                onClick={this.onClick}
                                onMouseOver={this.onMouseOver}
                                onMouseOut={this.onMouseOut} id="Oval-4-Copy-8">
                                <use
                                    id="2"
                                    fill={this.state.icons['2'].selected
                                        ? '#2D55B2'
                                        : '#FFF'}
                                    fillRule="evenodd"
                        ...
                        <g id="circle/hover" transform="translate(268.000000, 143.000000)">
                            <g
                                ...
                                <use
                                    id="3"
                                    fill={this.state.icons['3'].selected
                                        ? '#2D55B2'
                                        : '#FFF'}
                                    fillRule="evenodd"
                        ...
                        <g id="circle/hover" transform="translate(441.000000, 31.000000)">
                            <g
                                ...
                                <use
                                    id="4"
                                    fill={this.state.icons['4'].selected
                                        ? '#2D55B2'
                                        : '#FFF'}
                                    fillRule="evenodd"
                        ...
                        <g id="circle/hover" transform="translate(354.000000, 87.000000)">
                            <g
                                ...
                                <use
                                    id="5"
                                    fill={this.state.icons['5'].selected
                                        ? '#2D55B2'
                                        : '#FFF'}
                                    fillRule="evenodd"
                        ...
                        <text
                            ...
                            fontWeight="bold"
                            fill="#002A5E">
                            <tspan x="227.188" y="289">Potential return</tspan>
                        </text>
                        <text
                            id="Risk"
                            ...
                            fontWeight="bold"
                            fill="#002A5E">
                            <tspan x="72.076" y="168">Risk</tspan>
                        </text>

                        {(this.state.icons['5'].selected || this.state.icons['5'].hover) && <g id="tooltip/high" transform="translate(99.000000, 13.000000)">
                            <g id="Group-7">
                                <g id="Rectangle-7">
                            ...
                            <text
                                ...
                                fontWeight="normal"
                                fill="#4A4A4A">
                                <tspan x="16" y="20">I am willing to accept a high degree of risk in
                                </tspan>
                                <tspan x="16" y="37">order to grow my assets materially ahead of
                                </tspan>
                                <tspan x="16" y="54">inflation over the medium to long term</tspan>
                            </text>
                        </g>}
                        {(this.state.icons['4'].selected || this.state.icons['4'].hover) && <g id="tooltip/med-high" transform="translate(137.000000, 14.000000)">
                            <g id="Group-7">
                                <g id="Rectangle-7">
                            ...
                            <text
                                ...
                                fontWeight="normal"
                                fill="#4A4A4A">
                                <tspan x="16" y="20">I am seeking to maximise returns and am
                                </tspan>
                                <tspan x="16" y="37">willing to accept a high degree of risk in order
                                </tspan>
                                <tspan x="16" y="54">to target this objective</tspan>
                            </text>
                        </g>}
                        {(this.state.icons['3'].selected || this.state.icons['3'].hover) && <g id="tooltip/med" transform="translate(79.000000, 70.000000)">
                            <g id="Group-7">
                                <g id="Rectangle-7">
                            ...
                            <text
                                ...
                                fontWeight="normal"
                                fill="#4A4A4A">
                                <tspan x="16" y="20">I am willing to accept a moderate degree of risk
                                </tspan>
                                <tspan x="16" y="37">in order to grow my assets marginally ahead of
                                </tspan>
                                <tspan x="16" y="54">inflation over the medium to long term</tspan>
                            </text>
                        </g>}
                        {(this.state.icons['2'].selected || this.state.icons['2'].hover) && <g id="tooltip/low-med" transform="translate(56.000000, 126.000000)">
                            <g id="Group-7">
                                <g id="Rectangle-7">
                            ...
                            <text
                                ...
                                fontWeight="normal"
                                fill="#4A4A4A">
                                <tspan x="16" y="20">I am willing to accept a limited degree of risk
                                </tspan>
                                <tspan x="16" y="37">in order to grow my assets in line with inflation
                                </tspan>
                                <tspan x="16" y="54">over the medium to long term</tspan>
                            </text>
                        </g>}
                        <text
                            id="Lower-Copy"
                        ...
                        <text
                            ...
                            line-spacing="16"
                            fill="#4A4A4A">
                            <tspan x="166" y="321">In line with</tspan>
                            <tspan x="174.418" y="337">inflation</tspan>
                        </text>
                        <text
                            ...
                            line-spacing="16"
                            fill="#4A4A4A">
                            <tspan x="253" y="321">Marginally</tspan>
                            <tspan x="259.144" y="337">ahead of</tspan>
                            <tspan x="259.636" y="353">inflation</tspan>
                        </text>
                        <text
                            ...
                            line-spacing="16"
                            fill="#4A4A4A">
                            <tspan x="341" y="321">Materially</tspan>
                            <tspan x="345.554" y="337">ahead of
                            </tspan>
                            <tspan x="346.046" y="353">inflation</tspan>
                        </text>
                        <text
                            ...
                            line-spacing="16"
                            fill="#4A4A4A">
                            <tspan x="427" y="321">Maximised</tspan>
                            <tspan x="432.85" y="337">to target
                            </tspan>
                        </text>
                        {(this.state.icons['1'].selected || this.state.icons['1'].hover) && <g id="tooltip/low" transform="translate(26.000000, 197.000000)">
                            <g id="Group-7">
                                <g id="Rectangle-7">
                            ...
                            <text
                                ...
                                fontWeight="normal"
                                fill="#4A4A4A">
                                <tspan x="16" y="22">I am seeking to keep my capital safe and will
                                </tspan>
                                <tspan x="16" y="39">accept commensurately lower returns</tspan>
                            </text>
                        </g>}
                    </g>
                </svg>
